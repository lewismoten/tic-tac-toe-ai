(() => {
  ...
  module.exports = ({canMark, markAt, nextMark}) => {
    ...
    let candidates = wins
      ...
      .filter(hasOpponentMark.bind(null, canMark, markAt, nextMark))
  ...
  function hasOpponentMark(canMark, markAt, nextMark, cells) {

    return cells.some(cell => !canMark(cell.x, cells.y) && markAt(cell.x, cell.y) !== nextMark);
